...
import { clearBasket, deleteSelectedSushi, plusItemCart, minusItemCart } from '../redux/reducers/cart'
...
function Cart() {
  ...
  const addedSushiCart = Object.keys(items).map(key => {
  ...
  const deleteSelected = (id) => {
    dispatch(deleteSelectedSushi(id))
  }
  const plusItem = (id) => {
 ...
 basket</h2>
            ...
            (
              <div className="cart cart--empty">
                ...
                <p>
                  You didn't make order<br />
              for further action return to main page
            </p>
